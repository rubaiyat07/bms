    ...
    <div class="page-header">
      <div class="header-content">
        ...
        <div class="header-actions">
          <router-link :to="`/admin/employees/${employee.id}/edit`" class="btn btn-primary">
    ...
    <div class="employee-content">
        ...
        <div class="overview-grid">
          <div class="overview-card">
            ...
            <div class="card-content">
              <h3>{{ employee.projects?.length || 0 }}</h3>
              <p>Active Projects</p>
            </div>
          </div>
          ...
          <div class="overview-card">
            ...
            <div class="card-content">
              <h3>${{ employee.salary ? employee.salary.toLocaleString() : 'N/A' }}</h3>
              <p>Salary</p>
            </div>
          </div>
          ...
          <div class="overview-card">
            ...
            <div class="card-content">
              <h3>{{ employee.join_date ? formatDate(employee.join_date) : 'N/A' }}</h3>
              <p>Join Date</p>
            </div>
          </div>
        </div>
      ...
      <div class="details-section">
        ...
        <div class="details-grid">
          ...
          <div class="detail-item">
            <label>Gender</label>
            <p>{{ employee.gender ? employee.gender.charAt(0).toUpperCase() + employee.gender.slice(1) : 'Not specified' }}</p>
          </div>
      ...
      <div class="details-section">
        ...
        <div class="details-grid">
          ...
          <div class="detail-item">
            <label>Branch</label>
            <p>{{ employee.branch?.name || 'Not assigned' }}</p>
          </div>
          <div class="detail-item">
            <label>Manager</label>
            <p>{{ employee.manager?.name || 'Not assigned' }}</p>
          </div>
          <div class="detail-item">
            <label>Join Date</label>
            <p>{{ employee.join_date ? formatDate(employee.join_date) : 'Not specified' }}</p>
          </div>
          <div class="detail-item">
            <label>Salary</label>
            <p>{{ employee.salary ? `$${employee.salary.toLocaleString()}` : 'Not specified' }}</p>
          </div>
          <div class="detail-item">
            <label>Status</label>
          ...
          <div class="detail-item">
            ...
            <span :class="`performance-badge performance-${employee.performance_rating}`">{{ employee.performance_rating }}</span>
          </div>
        </div>
      </div>
      ...
      <div class="projects-section">
        <h2>Projects ({{ employee.projects?.length || 0 }})</h2>

        <div v-if="employee.projects?.length" class="projects-grid">
          <div v-for="project in employee.projects" :key="project.id" class="project-card">
